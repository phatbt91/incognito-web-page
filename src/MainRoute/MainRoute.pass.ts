// import {cachePromise, clearCache, getCache, cache} from "./MainRoute.cache";
...
// const APP_PASSWORD_KEY = "APP_PASSWORD_KEY";
// const APP_SALT_KEY = "APP_SALT_KEY";
// const APP_PASS_PHRASE_CIPHER = "APP_PASS_PHRASE_CIPHER";
//
// /**
...
//     clearCache(PASSPHRASE_WALLET_DEFAULT);
// };
//
// /**
...
//  * @returns {string} - JSON
//  */
// const getPasspharseFromStorage = async (): Promise<any> => {
//     return localStorage.getItem(APP_PASS_PHRASE_CIPHER);
// };
//
// /**
...
//         await localStorage.setItem(APP_PASS_PHRASE_CIPHER, passpharseCipherText);
...
//  */
// const getSaltFromStorage = async (): Promise<any> => {
//     return localStorage.getItem(APP_SALT_KEY);
// };
//
// /**
...
//             await localStorage.setItem(APP_SALT_KEY, salt);
//         }
